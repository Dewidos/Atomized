...
public class FurnaceGeneratorBlockScreen extends AbstractContainerScreen<FurnaceGeneratorBlockMenu> {

    private EnergyInfoArea energyInfoArea;
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Atomized.MOD_ID, "textures/gui/furnace_generator.png");

    public FurnaceGeneratorBlockScreen(FurnaceGeneratorBlockMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
